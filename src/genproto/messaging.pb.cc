...
const ::uint32_t TableStruct_messaging_2eproto::offsets[1] = {};
...
const char descriptor_table_protodef_messaging_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
    "\n\017messaging.proto\022\tmessaging2\013\n\tMessagin"
    "gb\006proto3"};
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::std::false_type _static_init2_ [[maybe_unused]] =
    (::_pbi::AddDescriptors(&descriptor_table_messaging_2eproto), ::std::false_type{});
